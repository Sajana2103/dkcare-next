...
const ServicesHTML = () => {
  ...
  return (
    <div className='page-content-wrapper'>
      ...
      <div id="services-intro" className={cls('pageContainer',styles.container)}>

        <div className={cls("gap40", styles.flex2)}>
          <div className="wPer40">

            <h1 className={cls("split-text blue bold text-large pageTitle", styles.mainTitle)}>We are available in</h1>
      ...
      <div id="services-types-emergencies" className={cls('blue-gr2 pageContainer', styles.container)}>
        <div className="">
          <h2 className={cls('split-text white pageTitle', styles.mainTitle)}>Types of Non-Emergencies</h2>
      ...
      <div id="services-convenience" className={cls('pageContainer', styles.container)}>
        <div className="">
          <h2 className={cls('split-text blue pageTitle', styles.mainTitle)}>Where convenience meets comfort</h2>
      ...
      <div id="services-success" className={cls('pageContainer', styles.container)}>
        <div className="">
        ...
        <div className="">
          <div className="title-bd-container hero-titles">
            <p className="blue bold pageTitle">DK Care Drivers</p>
            <div className="title-bd-blue" ></div>
          </div>
      ...
      <div id="services-covid" className={cls('blue-gr2 pageContainer', styles.container)}>
        <div className={cls("gap40", styles.flex2)}>
          <h2 className={cls('split-text white pageTitle', styles.mainTitle)}>Covid Prevention Guidelines</h2>
